...
function getConfigRoleta(){
  if(window.roletaConfigAtual && Array.isArray(window.roletaConfigAtual.premios)){
    return { limite:Number(window.roletaConfigAtual.limite||0), premios:window.roletaConfigAtual.premios };
  }
  return {limite:0,premios:[]};
}
