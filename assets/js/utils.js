...
function getCategoriasExcluidas(){return lerJsonLocal('categorias_excluidas',[]);}
function setCategoriasExcluidas(lista){salvarJsonLocal('categorias_excluidas',[...new Set(lista)]);}
...
function salvarConfigRoleta(cfg){salvarJsonLocal('config_roleta',{limite:Number(cfg.limite||0),premios:(cfg.premios||[]).slice(0,8)});}
