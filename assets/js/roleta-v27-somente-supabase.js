/* V27 - ROLETA SOMENTE SUPABASE (SEM localStorage)
...
(function(){
  ...
  const VERSAO = 'Roleta V27 - SOMENTE SUPABASE';
  ...
  function atualizarPainelStatus(extra){
    let el = document.getElementById('status-roleta-supabase-v27');
    const box = document.getElementById('lista-premios-roleta');
    if(!el && box){
      el = document.createElement('div');
      el.id = 'status-roleta-supabase-v27';
  ...
  window.girarRoletaV27 = async function(){
  ...
  window.girarRoleta = window.girarRoletaV27;
